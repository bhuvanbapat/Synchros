...
import com.flashreserve.outbox.FlashReserveTopics;
import com.flashreserve.outbox.OutboxEvent;
import com.flashreserve.outbox.OutboxPublisher;
...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.NONE,
        properties = {
                "flashreserve.kafka.enabled=true",
                ...
                "flashreserve.jobs.enabled=true",
                "flashreserve.outbox.poll-interval-ms=3600000",
                "flashreserve.expiration.scan-interval-ms=3600000",
...
class KafkaLoopIT {
    ...
    static {
        com.flashreserve.it.PostgresIntegrationBase.postgres().start();
        KAFKA.start();
    }

    @DynamicPropertySource
    static void props(DynamicPropertyRegistry registry) {
        var pg = com.flashreserve.it.PostgresIntegrationBase.postgres();
        ...
        registry.add("spring.kafka.bootstrap-servers",
                () -> "localhost:" + HOST_PORT);
        registry.add("flashreserve.kafka.enabled", () -> "true");
        registry.add("flashreserve.jobs.enabled", () -> "true");
        registry.add("flashreserve.outbox.poll-interval-ms", () -> "3600000");
        registry.add("flashreserve.expiration.scan-interval-ms", () -> "3600000");
    ...
    @Autowired FlashReserveTopics topics;
    ...
    @Autowired com.flashreserve.notification.NotificationRepository notificationRepo;
    ...
    void duplicateDeliveryProducesExactlyOneEffect() throws Exception {
        ...
        await("dedup marker written once").atMost(Duration.ofSeconds(30))
                ...
                .untilAsserted(() -> assertEquals(1, processedRepo
                        .findByEventIdAndConsumerGroup(eventId, "flashreserve").stream().count()));
