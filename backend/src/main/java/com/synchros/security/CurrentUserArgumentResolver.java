...
/**
 * Resolves @CurrentUser SynchrosUserDetails parameters directly from the
...
public class CurrentUserArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public boolean supportsParameter(MethodParameter parameter) {
        return parameter.hasParameterAnnotation(CurrentUser.class)
                && SynchrosUserDetails.class.isAssignableFrom(parameter.getParameterType());
    }
    ...
    public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer mavContainer,
        ...
        if (auth != null && auth.getPrincipal() instanceof SynchrosUserDetails details) {
            return details;
        }
