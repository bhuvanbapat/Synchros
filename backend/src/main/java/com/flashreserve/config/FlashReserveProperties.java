package com.flashreserve.config;

import org.springframework.boot.context.properties.ConfigurationProperties;

/** Type-safe application properties (flashreserve.* in application.yml). */
@ConfigurationProperties(prefix = "flashreserve")
public class FlashReserveProperties {
